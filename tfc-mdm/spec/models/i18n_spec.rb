...
RSpec.describe "Translations", type: :model do
  {
    ...
    Tfc::Mdm::Memberships::Category     => { locales: [:de] },
    Tfc::Mdm::Memberships::Event        => { locales: [:de] },
    Tfc::Mdm::Memberships::EventType    => { locales: [:de] },
    Tfc::Mdm::Memberships::Fee          => { locales: [:de] },
    Tfc::Mdm::Memberships::Membership   => { locales: [:de] },
    Tfc::Mdm::Positions::Entry          => { locales: [:de] },
    Tfc::Mdm::Positions::Exit           => { locales: [:de] },
    Tfc::Mdm::Positions::Position       => { locales: [:de] },
    Tfc::Mdm::Clubs::BankDetail         => { locales: [:de] },
    Tfc::Mdm::Clubs::Branch             => { locales: [:de] },
    Tfc::Mdm::Clubs::Club               => { locales: [:de] },
    Tfc::Mdm::Clubs::EmailAddress       => { locales: [:de] },
    Tfc::Mdm::Clubs::PhoneNumber        => { locales: [:de] },
    Tfc::Mdm::Clubs::SocialMedium       => { locales: [:de] },
